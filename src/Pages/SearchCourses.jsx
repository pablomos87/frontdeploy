  ...
  return (
    ...
    <Container fluid className="pb-5">
      ...
      {searchResults.length === 0 ? (
        <Col md={12} className="container-flex mt-5 pt-5 mb-5">
          <h3 className="mt-2 mb-2 pb-3 fw-bold"> No se encontraron resultados para su búsqueda </h3>
        </Col>
      ) : (
        <>
          <Col md={12} className="mt-5 mb-5">
            <h3 className="mb-2 pb-3 fw-bold"> Resultados de la búsqueda </h3>
          </Col>
